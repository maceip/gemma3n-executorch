# gemma3n-e4b-it export notes

## model details

- source: google/gemma-3n-E4B-it
- type: instruction-tuned multimodal model
- full model: 17b params (text + vision + audio)
- text-only: 7.40b params (35 transformer layers)
...
4. validate
   ```bash
   python ../validate.py gemma-3n-E4B-it-text-only.pte
   ```

## memory requirements

- e4b requires 20gb ram for export process
- recommend 32gb system ram
